...
class TestRefreshTiles:
    """Tests for `Farm.refresh_tiles`."""
    ...
    def test_dispatches_plant_tiles_to_refresh_plant(self):
    ...
    def test_resets_watered_today_for_surviving_plant(self):
        env = _make_env(farmer=(5, 5), players=2)
        farm = _farm(env)
    ...
    def test_dispatches_animal_tiles_to_refresh_animal(self):
    ...
    def test_keeps_fed_animal(self):
        env = _make_env(farmer=(5, 5), players=2)
        farm = _farm(env)
    ...
    def test_leaves_empty_tiles_empty(self):
        env = _make_env(farmer=(5, 5), players=2)
        farm = _farm(env)
    ...
    def test_leaves_existing_weeds_untouched(self):
        env = _make_env(farmer=(5, 5), players=2)
        farm = _farm(env)
    ...
    def test_leaves_locked_tiles_untouched(self):
    ...
    def test_mixed_grid_dispatches_each_appropriately(self):
    ...
    def test_full_grid_of_plants_dispatches_all(self):
    ...
    def test_only_touches_target_farm(self):
    ...
    def test_passes_state_to_refresh_plant_for_decay(self):
    ...
    def test_decay_turn_reduces_yield_via_refresh_plant(self):
