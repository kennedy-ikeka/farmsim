...
def test_spawn_weeds_chance_one_spawns_on_every_empty_tile():
...
def test_spawn_weeds_chance_zero_spawns_nothing():
    env = _make_env(farmer=(5, 5))
    farm = env.state.farms[0]
    rng = random.Random(0)
...
def test_spawn_weeds_does_not_replace_plants():
    env = _make_env(farmer=(5, 5))
    farm = env.state.farms[0]
...
def test_spawn_weeds_does_not_replace_existing_weeds():
    env = _make_env(farmer=(5, 5))
    farm = env.state.farms[0]
...
def test_spawn_weeds_deterministic_with_same_rng_seed():
...
def test_spawn_weeds_different_seeds_produce_different_layouts():
...
def test_spawn_weeds_works_on_non_square_grid():
...
def test_spawn_weeds_small_grid_all_empty():
