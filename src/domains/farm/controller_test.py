...
def test_apply_move_dispatches(direction, start, expected):
...
def test_apply_plant_dispatches():
...
def test_apply_water_dispatches():
...
def test_apply_harvest_dispatches():
...
def test_apply_fertilize_dispatches():
...
def test_apply_build_coop_dispatches():
    env = _make_env(farmer=(4, 4))
    farm = env.state.farms[0]
...
def test_apply_build_pasture_dispatches():
    env = _make_env(farmer=(4, 4))
    farm = env.state.farms[0]
...
def test_apply_feed_dispatches():
    env = _make_env(farmer=(4, 4))
    farm = env.state.farms[0]
...
def test_apply_collect_fertilizer_dispatches():
    env = _make_env(farmer=(4, 4))
    farm = env.state.farms[0]
...
def test_apply_care_dispatches():
    env = _make_env(farmer=(4, 4))
    farm = env.state.farms[0]
    farm.tiles[4][4] = AnimalState(kind="COOP", animal="GOOSE")
...
def test_apply_pickup_dispatches():
...
def test_apply_place_dispatches():
